...
>  _El sistema internacional se ha moldeado de acuerdo a las potencias dominantes y sus intereses durante las diferentes épocas._
...
>  _El papel de los arreglos regionales de seguridad merecen un mayor estímulo, si lo que la teoría plantea es un orden alternativo al existente._
...
Morton Kaplan (1921-2017) foi um dos teóricos mais influentes das relações internacionais do século XX, sendo Distinguished Service Professor de Ciência Política na Universidade de Chicago. Seu pensamento revolucionou o estudo das relações internacionais ao introduzir metodologias científicas e a análise sistêmica ao campo.

## Principais Contribuições Teóricas

### 1. **Teoria dos Sistemas Internacionais**

Kaplan introduziu uma nova ferramenta analítica ao estudo das relações internacionais: a análise de sistemas. Sua obra seminal "System and Process in International Politics" (1957) quebrou paradigmas na ciência política ao combinar conceitos de sistemas, teoria dos jogos e cibernética em suas formulações teóricas.

### 2. **Metodologia Científica**

Diferenciando-se dos teóricos do realismo que se concentram no Estado nacional como unidade de análise, Morton Kaplan descobriu e sustenta que o tipo de sistema internacional é o fator mais importante para entender a realidade mundial. Ele é considerado um dos precursores em introduzir metodologia científica ao campo das relações internacionais.

## Os Seis Modelos de Sistemas Internacionais

Kaplan desenvolveu seis modelos distintos de sistemas internacionais, cada um com suas próprias regras de comportamento e características estruturais:

### 1. **Sistema de Equilíbrio de Poder (Balance of Power)**

Sistema próprio da Europa do século XIX e primeira parte do século XX até a Segunda Guerra Mundial. É o único modelo que existiu historicamente. Seus atores são somente estados nacionais, há pelo menos cinco atores nacionais essenciais, as armas não são nucleares, e cada ator essencial está disposto a recorrer a alianças para conseguir seus objetivos.

### 2. **Sistema Bipolar Flexível**

Neste modelo operam atores nacionais e supranacionais. Existem dois blocos, cada um encabeçado por um ator nacional, assim como atores nacionais que não estão incluídos em nenhum dos blocos. As armas são nucleares. O sistema bipolar flexível é aquele em que a bipolarização não foi alcançada completamente: uma parte dos agentes políticos internacionais fica fora do sistema - os não alinhados.

### 3. **Sistema Bipolar Rígido**

É uma modificação do modelo anterior. Cada bloco está rigidamente hierarquizado e todos os atores nacionais estão ubicados dentro de um dos dois blocos. O sistema bipolar rígido alinha os distintos atores em dois grandes blocos de maneira absoluta, jerárquica e sem dar lugar à existência de países neutrales.

### 4. **Sistema Universal**

Este sistema propõe que os países se organizem em um sistema federal, por meio de um ator dominante, enquadrando o resto da comunidade internacional sob o princípio da tolerância mútua e o império universal do direito ou uma organização internacional.

### 5. **Sistema Hierárquico**

Se daria se uma superpotência se converte no ator universal e absorve todos os demais países, é um sistema diretivo. Pode ser tanto diretivo quanto não-diretivo - é diretivo se formado como resultado de conquista mundial por um ator nacional; é não-diretivo se baseado em regras democráticas.

### 6. **Sistema de Veto Unitário (Unit Veto)**

Este sistema representa um arranjo onde múltiplos atores possuem capacidade de veto sobre decisões fundamentais do sistema.

## Relevância Contemporânea

Embora desenvolvida durante a Guerra Fria, a abordagem sistêmica de Kaplan permanece relevante para analisar as relações internacionais contemporâneas, incluindo transições pós-Guerra Fria, potências emergentes como a China, e desafios transnacionais como mudanças climáticas, terrorismo e pandemias.

## Críticas e Limitações

Kenneth E. Boulding e Charles Kindleberger deram avaliações negativas ao "System and Process in International Politics" de Kaplan, argumentando que o trabalho não se prestava a testes empíricos e que a aplicação da teoria dos jogos à política e conflitos era problemática.

## Legado

Na área da ciência política, a influência de Kaplan é penetrante, com estudiosos de relações internacionais mundialmente aceitando sua visão de que o estudo da política mundial deve ser um empreendimento científico. O Prêmio Morton A. Kaplan, instituído em 1994 em sua honra, é concedido anualmente pelo Comitê de Relações Internacionais para o melhor trabalho de mestrado.

O pensamento de Morton Kaplan continua influenciando a compreensão teórica das relações internacionais, oferecendo ferramentas analíticas valiosas para compreender a dinâmica, transformação e estabilidade dos sistemas internacionais em um mundo cada vez mais complexo.

___

Robert Cox (1926-2018) foi um dos teóricos mais influentes das Relações Internacionais contemporâneas, sendo considerado junto com Susan Strange um dos principais fundadores da Economia Política Internacional e um líder da teoria crítica. Sua obra caracteriza-se por uma abordagem historicista inovadora sobre a ordem mundial e a economia política.

## Principais Contribuições Teóricas

### 1. **A Famosa Tese: "Theory is Always for Someone and for Some Purpose"**

"Theory is always for someone and for some purpose." Ou seja, todas as teorias têm perspectivas que derivam da realidade social e política 'peculiar', e não existe teoria em si mesma. Não há teoria neutra sobre assuntos humanos, nem teoria de validade universal.

Esta afirmação fundamental questiona a suposta neutralidade das teorias tradicionais e revela que todas as teorias são carregadas de valores e servem a algum propósito específico; assim, não há e não pode haver uma teoria objetiva.

### 2. **Distinção entre Teoria de Resolução de Problemas e Teoria Crítica**

Cox desenvolveu uma distinção analítica crucial:

#### **Teoria de Resolução de Problemas (Problem-Solving Theory)**

"toma o mundo como o encontra, com as relações sociais e de poder prevalecentes e as instituições nas quais elas estão organizadas, como o quadro dado para a ação. O objetivo geral da resolução de problemas é fazer essas relações e instituições funcionarem suavemente, lidando efetivamente com fontes particulares de problemas".

#### **Teoria Crítica**

questiona essas próprias condições estruturais que são pressupostos tácitos para a teoria de resolução de problemas, perguntando a quem e para quais propósitos tal teoria serve. Ela historiciza as ordens mundiais ao descobrir os propósitos que as teorias de resolução de problemas dentro de tal ordem servem para sustentar.

"A Teoria Crítica apresenta-se, assim, como uma teoria normativa, que procura mudança. Logo, rejeita a imutabilidade das estruturas. Esta sublinha, também, a existência de tendências contra-hegemônicas".

## Estrutura Teórica: As Três Categorias Analíticas

Cox desenvolveu um framework analítico baseado em três categorias fundamentais:

### 1. **Capacidades Materiais**

Potencial produtivo ou destrutivo - incluindo recursos naturais, tecnologia e armamentos.

### 2. **Ideias**

Noções sobre as relações sociais e expectativas de comportamentos, ou legitimidade das relações de poder. São subdivididas em intersubjetivas que ajudam a legitimar o mundo como ele é e em coletivas, ou seja, visões de diversos grupos sociais.

### 3. **Instituições**

Meio para estabilizar e perpetuar as ordens dominantes. Servem para estabilizar uma ordem dominante.

## Os Três Níveis de Análise

Essas três forças possuem três níveis de atuação: as *forças sociais* que influenciam o modo e processo de produção; as *formas de estados*, derivadas do complexo sociedade/estado; e *as ordens mundiais* que definem as configurações de força em nível internacional.

## Influência Gramsciana: Hegemonia e Bloco Histórico

### **Conceito de Hegemonia**

A hegemonia de Gramsci é a capacidade que um grupo social possui para exercer uma função de direção política e moral na sociedade. A hegemonia, exercida por forças sociais que detêm o controle do Estado, tem por finalidade a produção do consentimento nas demais.

### **Bloco Histórico**

As possibilidades de mudança surgem da noção de bloco histórico, ou seja, as relações entre a base material (infraestrutura) e as práticas político-ideológicas que sustentam uma certa ordem.

### **Estado Ampliado**

Cox não diminui o papel do Estado, classificando-o como a unidade básica das Relações Internacionais, pois é o lugar onde os conflitos de ordem social acontecem, mas o Estado que é a unidade básica das Relações Internacionais é o Estado ampliado, deixando de lado a concepção reducionista de Estado como aparelho burocrático-militar.

## Materialismo Histórico e Abordagem Transformadora

Cox adiciona a dimensão vertical à dimensão horizontal de poder entre Estados rivais, apontada pelo realismo. O materialismo histórico expande a perspectiva da política internacional para a relação entre Estado e sociedade civil, tornando o complexo Estado/sociedade o ente constituinte da ordem mundial.

Para se distanciar da teoria tradicional, a teoria crítica deve afastar-se da ordem mundial dominante, e questionar-se de como essa ordem se formou. Cox defende um foco na abrangência total das relações de poder modernas.

## Análise da Ordem Mundial Contemporânea

### **Globalização e Neoliberalismo**

O novo bloco histórico transnacional, revestido por uma ideologia chamada por Cox de "hiper-liberal" e por Gill de "neoliberal", tomaria a vanguarda da economia política global buscando formatar a globalização aos interesses de livre circulação e desoneração dos capitais transnacionais.

### **Internacionalização das Forças Produtivas**

As concepções neorrealistas de poder hegemônico, que enfatizam a concorrência dos interesses nacionais dos Estados soberanos, começam a quebrar. Harmonização da política transnacional, Internacionalização da produção, Classe de interesses globais que transcende fronteiras do Estado.

## Método e Perspectiva Histórica

História para Cox não é uma sequência de eventos mas uma forma holística de pensar sobre o mundo. A perspectiva histórica atual divide o mundo em política, economia, antropologia e assim por diante. Uma perspectiva histórica significa tomar as coisas que ocorrem dentro de um contexto histórico todas juntas.

## Posicionamento Teórico nas Relações Internacionais

Robert Cox se posiciona como um **teórico crítico neogramsciano**, caracterizado por:

1. **Epistemologicamente**: Rejeita o positivismo e a neutralidade teórica
2. **Metodologicamente**: Adota o materialismo histórico e a análise estrutural
3. **Normativamente**: Busca a transformação social e a emancipação
4. **Ontologicamente**: Vê as estruturas sociais como historicamente contingentes

## Legado e Influência

O papel da teoria crítica no revigoramento dos debates teóricos é primordial, com ênfase especial dedicada ao trabalho de Robert W. Cox. O pensamento neogramsciano é inspecionado à luz da busca pela transformação social nas relações internacionais.

Cox continua sendo uma referência fundamental para estudiosos da economia política internacional, com suas categorias de estrutura histórica (capacidades materiais, ideias e instituições), forças sociais e hegemonia fornecendo instrumentos importantes para analisar as transformações em curso na ordem mundial.

O pensamento de Robert Cox representa uma das mais importantes contribuições para a teoria crítica das relações internacionais, oferecendo ferramentas analíticas que permitem compreender não apenas como o mundo é, mas também como ele pode ser transformado através da ação emancipatória e da contestação das hegemonias dominantes.