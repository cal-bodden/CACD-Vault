...
graph TD
    ...
    A1 -- "Aprovação de Orçamento, CPIs, Impeachment, Derrubada de Veto" --> B1
    B1 -- "Veto a Leis, Edição de MPs" --> A1
    C1 -- "Controle de Constitucionalidade de Leis" --> A1
    C1 -- "Controle de Constitucionalidade de Atos Normativos" --> B1
    A1 -- "Aprovação de Ministros do STF, Processo de Impeachment de Ministros" --> C1
    B1 -- "Nomeação de Ministros do STF" --> C1
```
