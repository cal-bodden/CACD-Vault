...
```mermaid
flowchart LR
    A[Estado estrangeiro - Pedido de extradicao] -- Encaminha ao MJSP/DRCI --> B[Ministerio da Justica - Autoridade Central]
    B -- Analise formal --> C{STF: Legalidade do pedido}
    C -- Deferido --> D[Presidente da Republica - Decisao final de entrega]
    C -- Indeferido --> E[Extradicao negada - Encerramento]
    D -- Autoriza entrega --> F[Entrega do extraditando ao Estado requerente]
    D -- Nega entrega --> E[Extradicao negada - Encerramento]
```
