...
```mermaid
graph TD
    A[Bens Econômicos] --> B[Rival + Excluível<br/>BENS PRIVADOS]
    A --> C[Rival + Não-Excluível<br/>RECURSOS COMUNS]
    A --> D[Não-Rival + Excluível<br/>BENS DE CLUBE]
    A --> E[Não-Rival + Não-Excluível<br/>BENS PÚBLICOS]
    
    B --> F[Chocolate, roupas<br/>carros, alimentos]
    C --> G[Peixes oceânicos<br/>Amazônia, aquíferos]
    D --> H[TV a cabo, pedágios<br/>clubes, streaming]
    E --> I[Defesa nacional<br/>iluminação pública]
```
