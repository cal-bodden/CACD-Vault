---
title: "RCCN — Cap. 2 (organizado): Legislatura, SLO, Convocação Extraordinária, Sessão Conjunta, Direção e Lideranças"
tags: [RCCN, CF, legislatura, SLO, convocacao-extraordinaria, sessao-conjunta, mesas, liderancas]
cssclass: wide
---
...
Fonte e detalhamento do quadro: curso (Cap. 3) com âncoras explícitas a **RCCN art. 1º**. :contentReference[oaicite:0]{index=0}
...
Ver **quadro 8** (curso) com marcação solene x deliberativa por item do **art. 1º do RCCN**. :contentReference[oaicite:2]{index=2} :contentReference[oaicite:3]{index=3}

## 3.3 Processo de votação (separação de Casas)
- **Votos computados separadamente**; regra: vota primeiro a **CD** e depois o **SF**; **exceção**: em **veto de projeto de iniciativa de senador**, começa pelo **Senado** (RCCN **art. 43**). :contentReference[oaicite:4]{index=4}  
- **Voto contrário de uma Casa** → **rejeição** da matéria (RCCN **art. 43 §1º**). :contentReference[oaicite:5]{index=5}

> [!tip] Lembrete conceitual
> Sessão conjunta = reunião simultânea **no mesmo local**, mas **votação separada por Casa**. Não confundir com **sessão unicameral** da revisão constitucional (1994). :contentReference[oaicite:6]{index=6}

## 3.4 Modalidades de votação (RCCN arts. **44–47**)
- **Simbólica** (padrão): líderes **representam** votos dos liderados; cabe **verificação** por líder, 5 senadores ou 20 deputados (art. **45**). :contentReference[oaicite:7]{index=7}  
- **Nominal**: hoje operacionalizada por **painel eletrônico** em hipóteses regimentais (art. **46** e regras de vetos **106-B/106-D**, quando aplicável). *(ver curso para contexto e histórico)* :contentReference[oaicite:8]{index=8}  
...
- **Adiamento**: **não** há adiamento de **discussão**; é possível **adiar votação** por **até 48h**, **somente por líder** e **sem** prejudicar prazos constitucionais (**art. 40**). :contentReference[oaicite:11]{index=11}  
- **Requerimentos em sessão conjunta**: **não** se discutem; cada Casa pode **encaminhar** por 2 membros (5 min.) (**art. 41**). :contentReference[oaicite:12]{index=12}

> [!example] **Veto e prazo constitucional**
> O prazo de **30 dias** para apreciar veto (**CF 66 §4º**) conta da **protocolização** na **Presidência do Senado** (RCCN **art. 104-A**). Isso impacta a avaliação de **adiamento de votação** (art. **40** in fine). :contentReference[oaicite:13]{index=13} :contentReference[oaicite:14]{index=14}
...
> [!note] **Local da sessão e ordem do dia**  
> Regra do **local** e exemplos práticos: ver seção 3.1.  
> **Expediente** (art. 30), **ordem do dia** (art. 32) e **avulsos** com 24h de antecedência — rotinas da sessão conjunta.
...
```mermaid
flowchart TD
  A[Convocacao extraordinaria] --> B{Hipotese}
  B -->|Defesa, Intervencao, Sitio, Posse| C[Presidente do Senado convoca]
  B -->|Urgencia ou Relevancia| D[PR; PRs da CD e SF; Maioria de ambas]
  D --> E{Aprovacao?}
  E -->|Maioria absoluta em cada Casa| F[Convocacao valida]
  E -->|Nao| G[Convocacao rejeitada]
```
