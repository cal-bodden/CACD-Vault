...
graph TD
    subgraph BRI
        direction LR
        A --> B(Nova Ponte Continental Eurasiática);
        A --> C(Corredor China-Mongólia-Rússia);
        A --> D(Corredor China-Ásia Central-Ásia Ocidental);
        A --> E(Corredor China-Paquistão - CPEC);
        A --> F(Corredor Bangladesh-China-Índia-Mianmar - BCIM);
        A --> G(Corredor China-Península da Indochina);
        H --> I(Portos e Rotas Marítimas);
    end
```
