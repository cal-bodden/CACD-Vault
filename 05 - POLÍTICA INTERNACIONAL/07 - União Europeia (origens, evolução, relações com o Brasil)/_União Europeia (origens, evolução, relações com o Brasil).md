...
```mermaid
graph TD
    A[União Europeia - 27 Membros] --> B[Conselho Europeu]
    A --> C[Conselho da UE]
    A --> D[Comissão Europeia]
    A --> E[Parlamento Europeu]
    A --> F[Tribunal de Justiça]
    A --> G[Banco Central Europeu]
    
    B --> B1[Chefes de Estado/Governo]
    B --> B2[Orientações Políticas Gerais]
    
    C --> C1[Ministros dos Estados-Membros]
    C --> C2[Poder Legislativo]
    C --> C3[Celebração de Acordos]
    
    D --> D1[Poder Executivo]
    D --> D2[Presidente: Ursula von der Leyen]
    D --> D3[Defesa dos Interesses Gerais]
    
    E --> E1[Representação dos Cidadãos]
    E --> E2[Poder Legislativo Compartilhado]
...
```mermaid
graph LR
    A[1957: Europa dos 6] --> B[1973: Europa dos 9]
    B --> C[1981-86: Europa dos 12]
    C --> D[1995: Europa dos 15]
    D --> E[2004-07: Europa dos 27]
    E --> F[2013: Europa dos 28]
    F --> G[2020: Brexit - Europa dos 27]
