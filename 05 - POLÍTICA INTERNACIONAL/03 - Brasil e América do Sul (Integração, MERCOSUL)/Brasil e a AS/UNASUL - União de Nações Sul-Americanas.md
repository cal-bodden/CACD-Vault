...
```mermaid
graph TD
    ConselhoChefes["Conselho de Chefes de Estado e de Governo"]
    ConselhoMinistros["Conselho de Ministros das Relações Exteriores"]
    ConselhoDelegados["Conselho de Delegados"]
    SecretariaGeral["Secretaria-Geral (Quito)"]

    ConselhoChefes --> ConselhoMinistros
    ConselhoMinistros --> ConselhoDelegados
    ConselhoDelegados --> SecretariaGeral

    subgraph Conselhos_Setoriais
        CDS["Defesa Sul-Americana (CDS)"]
        COSIPLAN["Infraestrutura e Planejamento (COSIPLAN)"]
        Saude["Saúde"]
        Desenvolvimento["Desenvolvimento Social"]
        Economia["Economia e Finanças"]
        Educacao["Educação, Ciência e Cultura"]
        Seguranca["Drogas e Segurança Cidadã"]
    end

    SecretariaGeral --> CDS
    SecretariaGeral --> COSIPLAN
    SecretariaGeral --> Saude
    SecretariaGeral --> Desenvolvimento
    SecretariaGeral --> Economia
    SecretariaGeral --> Educacao
    SecretariaGeral --> Seguranca
```
