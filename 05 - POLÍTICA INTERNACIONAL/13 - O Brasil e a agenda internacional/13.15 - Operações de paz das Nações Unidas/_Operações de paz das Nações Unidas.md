...
graph TD
    ...
    A1["Mandatos restritos<br/>Consentimento<br/>Não uso da força"] --> A
    B1["DDR<br/>Direitos humanos<br/>Peacebuilding"] --> B
    C1["Capítulo VII<br/>Proteção de civis<br/>Uso da força"] --> C
```
