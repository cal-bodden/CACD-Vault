...
```mermaid
timeline
    title Comércio Global: mercadorias vs serviços (2019–2025)
    2019 : início base
    2020 : mercadorias -5%, serviços -10%
    2021 : mercadorias +6%, serviços +12%
    2022 : mercadorias +2%, serviços +9%
    2023 : mercadorias -1.2%, serviços +9%
    2024 : mercadorias +2.6%, serviços +9%
    2025 : mercadorias +3.3%
```
...
```mermaid
flowchart LR
    B((Brasil)) -->|Soja, Minerio de ferro, Petroleo, Carnes| CH[China]
    B -->|Commodities agricolas, Minerios; + alguns manufaturados| EU[Uniao Europeia]
    B -->|Oleo bruto, Semi-manufaturados; Aeronaves e outros manuf.| US[Estados Unidos]
    B -->|Manufaturados - Veiculos, Maquinas, Quimicos| AR[Argentina / Mercosul]
```
...
```mermaid
flowchart LR
  subgraph Exportacoes [Exportações Brasil]
    Soja["Soja (15%)"]
    Petroleo["Petroleo Cru (14%)"]
    Ferro["Minerio de Ferro (9%)"]
    Acucar["Acucar (5,5%)"]
    CarneBov["Carne Bovina (3,2%)"]
    Farelo["Farelo de Soja (3,1%)"]
    Celulose["Celulose (3,1%)"]
    Cafe["Cafe (3%)"]
    CarneAve["Carne de Aves (2,6%)"]
  end
  subgraph Importacoes [Importações Brasil]
    Maquinas["Maquinas e Bens de Capital"]
    Fertilizantes["Fertilizantes"]
    Eletronicos["Eletronicos"]
    Veiculos["Veiculos e Autopecas"]
    Quimicos["Produtos Quimicos"]
    Combustiveis["Combustiveis diversos"]
  end
  Soja --> China
  Soja --> UE["Uniao Europeia"]
  Petroleo --> China
  Petroleo --> EUA["EUA"]
  Ferro --> China
  Ferro --> Japao
  ...
  EUA -.-> Importacoes
  UE -.-> Exportacoes
  Argentina -.-> Importacoes
  Russia -.-> Importacoes
  Japao -.-> Exportacoes
  
  style Exportacoes fill:#eef,stroke:#888,stroke-width:2px
  style Importacoes fill:#fee,stroke:#888,stroke-width:2px
```
