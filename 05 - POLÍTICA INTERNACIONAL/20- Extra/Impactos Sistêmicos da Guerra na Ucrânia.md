...
```mermaid
graph TD
    A[Guerra na Ucrânia<br/>Fev 2022] --> B[Impactos Sistêmicos]
    
    B --> C[Segurança<br/>Alimentar/Energética]
    B --> D[Relações entre<br/>Grandes Potências]
    B --> E[Arquitetura<br/>Segurança Europeia]
    B --> F[Sistema<br/>Multilateral/ONU]
    
    C --> C1[Crise Energética Global]
    C --> C2[REPowerEU]
    C --> C3[Insegurança Alimentar]
    C --> C4[Iniciativa Grãos Mar Negro]
    
    D --> D1[Consolidação<br/>Ocidente vs Leste]
    D --> D2[Parceria<br/>Sino-Russa]
    D --> D3[Sul Global<br/>Não-Alinhado]
    
    E --> E1[Expansão OTAN<br/>Finlândia/Suécia]
    E --> E2[Rearmamento<br/>Europeu]
    E --> E3[Meta 5% PIB<br/>até 2035]
    
    F --> F1[Paralisia CSNU]
    F --> F2[Protagonismo<br/>AGNU/TPI]
    F --> F3[Crise do<br/>Multilateralismo]
    
    style A fill:#ff6b6b,stroke:#c92a2a,stroke-width:3px
    style B fill:#4ecdc4,stroke:#0b7285,stroke-width:2px
    style C fill:#ffe66d,stroke:#fab005,stroke-width:2px
    style D fill:#a8e6cf,stroke:#37b24d,stroke-width:2px
    style E fill:#ff8cc8,stroke:#d658a6,stroke-width:2px
    style F fill:#c7ceea,stroke:#5f3dc4,stroke-width:2px
```
